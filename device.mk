...
PRODUCT_PACKAGES += \
    ...
    init.sku.600WW.B2A.1.rc \
    init.sku.600WW.B2A.2.rc \
    init.sku.600WW.B2C.rc \
    init.sku.600WW.B2L.1.rc \
    init.sku.600WW.B2L.2.rc \
    init.sku.rc \
    init.target.rc \
    init.vibrator.rc \
...
# Inherit vendor
$(call inherit-product, vendor/nokia/Onyx/Onyx-vendor.mk)